...
class SasfeModelSincontactos extends JModelLegacy{

  public function insertarContacto($gteVentasId, $agtVentasId, $nombre, $aPaterno, $aMaterno, $email, $telefono, $fuente,
      $desarrolloId, $estatusId, $fechaAlta, $fechaActualizacion, $activo, $usuarioId,$usuarioIdActualizacion, $credito){

     $db = JFactory::getDBO();
     $tbl_sasfe_datos_contactos = $db->getPrefix().'sasfe_datos_contactos';
     // $fechaNac = ($fechaNac!="") ?"'".$fechaNac."'" :"NULL";

     $query = "INSERT INTO $tbl_sasfe_datos_contactos (
                          gteVentasId, agtVentasId, nombre, aPaterno, aMaterno, email, telefono, fuente,
                          desarrolloId, estatusId, fechaAlta, fechaActualizacion, activo, usuarioId,
                          usuarioIdActualizacion, credito)
                    VALUES (
                    $gteVentasId, $agtVentasId, '$nombre', '$aPaterno', '$aMaterno', '$email', '$telefono', '$fuente',
                    $desarrolloId, $estatusId, '$fechaAlta', '$fechaActualizacion', '$activo', $usuarioId,
                    $usuarioIdActualizacion, '$credito')";
  ...
  public function actualizarContacto($gteVentasId, $agtVentasId, $nombre, $aPaterno, $aMaterno, $email, $telefono, $fuente,
      $desarrolloId, $estatusId, $fechaAlta, $fechaActualizacion, $activo, $usuarioId,$usuarioIdActualizacion, $credito, $idDatoContacto){

     $db = JFactory::getDBO();
     $tbl_sasfe_datos_contactos = $db->getPrefix().'sasfe_datos_contactos';
     // $fechaNac = ($fechaNac!="") ?"'".$fechaNac."'" :"NULL";

     $query = "UPDATE $tbl_sasfe_datos_contactos SET  
                          gteVentasId=$gteVentasId, agtVentasId=$agtVentasId, nombre='$nombre', aPaterno='$aPaterno', aMaterno='$aMaterno', email='$email', telefono='$telefono', fuente='$fuente',
                          desarrolloId=$desarrolloId, estatusId=$estatusId, fechaAlta='$fechaAlta', fechaActualizacion='$fechaActualizacion', activo='$activo', usuarioId=$usuarioId,
                          usuarioIdActualizacion=$usuarioIdActualizacion, credito='$credito'
