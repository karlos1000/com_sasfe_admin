...
class SasfeControllerCatporcentajes extends JControllerForm {
...
//            print_r($arrPct);
//        echo '</pre>';
//        echo '$idPorcentajePEsc: ' .$idPorcentajePEsc. '<br/>';
//        echo '$pctUnoPCEsc: ' .$pctUnoPCEsc. '<br/>';        
//        echo '$pctDosPCEsc: ' .$pctDosPCEsc . '<br/>';        
