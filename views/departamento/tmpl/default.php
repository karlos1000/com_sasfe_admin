...
$datoProspectoId = (isset($this->data[0]->datoProspectoId))?$this->data[0]->datoProspectoId:'';
                ...
                <div class="col50">
                    <fieldset class="adminform">
                        ...
                        <?php if( (in_array("8", $this->groups) || in_array("10", $this->groups)) ){
                            ...
                            $idDatoProspecto = ($datoProspectoId!='')?$datoProspectoId:0;
                            $idDatoGeneral = ($idDatoGeneral!='')?$idDatoGeneral:0;
                            $datosEnlace = $modelGM->obtEnlaceDigitalPorIdPCDB($idDatoProspecto, $idDatoGeneral);
                            if($datosEnlace){
                                $linkGeneral = ($datosEnlace->linkGeneral!="") ?$datosEnlace->linkGeneral :$linkGeneral;
                                $linkContrato = ($datosEnlace->linkContrato!="") ?$datosEnlace->linkContrato :$linkContrato;
                                $linkEscrituras = ($datosEnlace->linkEscrituras!="") ?$datosEnlace->linkEscrituras :$linkEscrituras;
                                $linkEntregas = ($datosEnlace->linkEntregas!="") ?$datosEnlace->linkEntregas :$linkEntregas;
                            }
                        ?>
                        <div class="control-group">
                            <div class="control-label">
                            ...
                            <div class="controls">
                                ...
                                <a href="javascript:void(0);"
                                        idProspecto="<?php echo ($datoProspectoId!='')?$datoProspectoId:0;?>"
                                        idDatoGeneral="<?php echo ($idDatoGeneral!='')?$idDatoGeneral:0;?>"
                                        tipoEnlace="1"
                                        class="selLinkAbrir"
                                        id="lgeneral_0">
                        ...
                        <div class="control-group">
                            <div class="control-label">
                                <label for="expGeneral">Contrato PROFECO:</label>
                            </div>
                            <div class="controls">
                                <input type="text" name="expContrato" id="expContrato" value="<?php echo $linkContrato; ?>" style="width:180px;" readonly/>
                                <a href="javascript:void(0);"
                                    idProspecto="<?php echo ($datoProspectoId!='')?$datoProspectoId:0;?>"
                                    idDatoGeneral="<?php echo ($idDatoGeneral!='')?$idDatoGeneral:0;?>"
                                    tipoEnlace="2"
                        ...
                        <div class="control-group">
                            <div class="control-label">
                                <label for="expGeneral">Escrituras:</label>
                            </div>
                            <div class="controls">
                                <input type="text" name="expEscrituras" id="expEscrituras" value="<?php echo $linkEscrituras; ?>" style="width:180px;" readonly/>
                                <a href="javascript:void(0);"
                                    idProspecto="<?php echo ($datoProspectoId!='')?$datoProspectoId:0;?>"
                                    idDatoGeneral="<?php echo ($idDatoGeneral!='')?$idDatoGeneral:0;?>"
                                    tipoEnlace="3"
                        ...
                        <div class="control-group">
                            <div class="control-label">
                                <label for="expGeneral">Entrega:</label>
                            </div>
                            <div class="controls">
                                <input type="text" name="expEntrega" id="expEntrega" value="<?php echo $linkEntregas; ?>" style="width:180px;" readonly/>
                                <a href="javascript:void(0);"
                                    idProspecto="<?php echo ($datoProspectoId!='')?$datoProspectoId:0;?>"
                                    idDatoGeneral="<?php echo ($idDatoGeneral!='')?$idDatoGeneral:0;?>"
                                    tipoEnlace="4"
