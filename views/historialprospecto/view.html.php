...
class  SasfeViewHistorialprospecto extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
        ...
        {                     
            ...
            $document->addStyleDeclaration('.icon-48-historialprospecto {background-image: url(../media/com_sasfe/images/prospecto.png);}');                
            JToolBarHelper::title(JText::_('Historial Prospecto'), 'historialprospecto');
            JToolBarHelper::cancel('historialprospecto.cancel');
        ...
        protected function setDocument() 
        {
            ...
            $document = JFactory::getDocument();                                            
            $document->setTitle(JText::_('Historial Prospecto'));                                
            ...
            $document->addScript(JURI::root().'administrator/components/com_sasfe/views/historialprospecto/submitbutton.js');                         
        }
}
