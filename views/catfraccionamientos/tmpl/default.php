...
<form action="<?php echo JRoute::_('index.php?option=com_sasfe&view=catfraccionamientos'); ?>" method="post" name="adminForm" id="adminForm">
        ...
        <thead>
            <tr>
                <th width="5" class="nowrap center">                    
                    <?php echo JHtml::_('grid.sort', 'ID', 'idFraccionamiento', $direction, $ordering); ?>                    
                </th>
                ...
                <th width="100" class="nowrap center">                    
                    <?php echo JHtml::_('grid.sort', 'Imagen', 'imagen', $direction, $ordering); ?>  
                </th>                                
                <th class="nowrap center">                    
        ...
        <tbody>            
            <?php foreach ($this->items as $i => $item): ?>
                ...
                <tr class="row<?php echo $i % 2; ?>">
                    <td>
                        <?php echo $item->idFraccionamiento; ?>
                    </td>
                    <td>
                        <?php echo JHtml::_('grid.id', $i, $item->idFraccionamiento); ?>
                    </td>
                    <td class="center" style="line-height: 48px;">
                        <a href="<?php echo JRoute::_('index.php?option=com_sasfe&view=catfraccionamiento&layout=edit&id=' . $item->idFraccionamiento); ?>">
                            <?php echo $item->nombre; ?>
                       </a>                        
                    </td>
                    <td class="center">
                        <?php 
                            $this->imgPath = JURI::root().'media/com_sasfe/upload_files'; //ruta para mostrar las images de los fraccionamientos
                            if($item->imagen!=''){ ?>                                
                                <img src="<?php echo $this->imgPath.'/'.$item->imagen;?>" style="height:48px;">
                           <?php                                                                
                            }else{
