...
<form action="<?php echo JRoute::_('index.php?option=com_sasfe&view=catgenericos&id_cat='.$this->idCatGen); ?>" method="post" name="adminForm" id="adminForm">
        ...
        <thead>
            <tr>
                <th width="5" class="nowrap center">                    
                    <?php echo JHtml::_('grid.sort', 'ID', 'idDato', $direction, $ordering); ?>                    
                </th>
                ...
                <th width="20" class="nowrap center">
                    <?php echo JHtml::_('grid.sort', 'Por default', 'default', $direction, $ordering); ?>  
                </th>                               
                <th width="20" class="nowrap center">
        ...
        <tbody>            
            <?php foreach ($this->items as $i => $item): ?>
                ...
                <tr class="row<?php echo $i % 2; ?>">
                    <td class="center">
                        <?php echo $item->idDato; ?>
                    </td>
                    <td class="center">
                        <?php echo JHtml::_('grid.id', $i, $item->idDato); ?>
                    </td>
                    <td class="center">
                        <a href="<?php echo JRoute::_('index.php?option=com_sasfe&view=catgenerico&layout=edit&id='.$item->idDato.'&id_cat='.$this->idCatGen ); ?>">
                            <?php echo $item->nombre; ?>
                       </a>                        
                    </td>                    
                    <td class="center">
                        <?php                         
                        echo ($item->pordefault=='1') ? 'Si' :'No' ;?>
                    </td>                                                            
                    <td class="center">
                        <?php                         
