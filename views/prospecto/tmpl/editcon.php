...
$idContacto = SasfehpHelper::desencriptarCadena(JRequest::getVar('idcont')); // obtener identificador del contacto
$this->data = $modelContacto->obtenerDatosContacto($idContacto); // obtener datos del contacto por medio de us id
...
$tipoCreditoId = (isset($this->data[0]->credito))?$this->data[0]->credito:'';
...
$idTipoCaptado = (isset($this->data[0]->fuente))?$this->data[0]->fuente:'';
...
if($this->id==0){
    $datosAsesor = SasfehpHelper::obtInfoUsuariosJoomla($agtVentasId);
    // echo "<pre>"; print_r($datosAsesor); echo "</pre>";

    //Esta creando
    $nombreUsrJoomla = $datosAsesor->name; //Nombre del usuario joomla que esta creando el prospecto
    $idUsuarioJoomla = $agtVentasId; //id del usuario joomla que esta creando el prospecto
...
<form class="form-validate form-horizontal" action="<?php echo JRoute::_('index.php?option=com_sasfe&task=prospecto'); ?>" method="post" name="adminForm" id="adminForm">
    ...
    <?php } ?>
    <!-- <div id="alrduplicado" style="display: none;">
    </div> -->
    <div style="">
        ...
        <fieldset class="adminform">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" name="RFC" id="RFC" value="<?php echo $RFC; ?>" class="required mayuscula" style="width:150px;"/>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" name="NSS" id="NSS" value="<?php echo $NSS; ?>" class="required mayuscula" style="width:150px;" />
                </div>
            </div>
            <div class="control-group">
                <div class="control-label">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <textarea name="comentario" id="comentario" rows="5" class="required mayuscula" style="width:350px;"><?php echo $comentario; ?></textarea>
                </div>
            </div>
            <div class="control-group">
                <div class="control-label">
                ...
                <div class="controls">
                    <input type="text" name="empresa" id="empresa" value="<?php echo $empresa; ?>" class="required mayuscula" style="width:180px;" />
                </div>
            </div>
            <div class="control-group">
                <div class="control-label">
                ...
                <div class="controls">
                    <select id="captadoen" name="captadoen" class="required">
                        <option value="">--Seleccione--</option>
                        <?php
    ...
    <input type="hidden" name="idContacto" id="idContacto" value="<?php echo $idContacto; ?>" />
...
<script>
//Ocultar las siguientes acciones
JQ(document).ready(function(){
    JQ("#toolbar-save").hide();
    JQ("#toolbar-save-new").hide();
});
</script>