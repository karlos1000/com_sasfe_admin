...
<form action="<?php echo JRoute::_('index.php?option=com_sasfe&view=cattipocaptados'); ?>" method="post" name="adminForm" id="adminForm">
        ...
        <thead>
            <tr>
                <th width="5" class="nowrap center">                    
                    <?php echo JHtml::_('grid.sort', 'ID', 'idTipoCaptado', $direction, $ordering); ?>                    
                </th>
                <th width="20" class="nowrap center">
                    <?php echo JText::_('Sel'); ?>                    
                </th>			
                <th class="nowrap center">                    
                    <?php echo JHtml::_('grid.sort', 'Nombre', 'tipoCaptado', $direction, $ordering); ?>  
                </th>
                <th class="nowrap center">                    
        ...
        <tbody>
            <?php foreach ($this->items as $i => $item): ?>
                ...
                <tr class="row<?php echo $i % 2; ?>">
                    <td>
                        <?php echo $item->idTipoCaptado; ?>
                    </td>
                    <td>
                        <?php echo JHtml::_('grid.id', $i, $item->idTipoCaptado); ?>
                    </td>
                    <td class="center">
                        <a href="<?php echo JRoute::_('index.php?option=com_sasfe&view=cattipocaptado&layout=edit&id=' . $item->idTipoCaptado); ?>">
                            <?php echo $item->tipoCaptado; ?>
                       </a>                        
                    </td>                    
                    <td class="center">
                        <?php                         
