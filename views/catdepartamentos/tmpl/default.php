...
<form action="<?php echo JRoute::_('index.php?option=com_sasfe&view=catdepartamentos'); ?>" method="post" name="adminForm" id="adminForm">
        ...
        <thead>
            <tr>
                ...
                <th width="100" class="nowrap center">
                    <?php echo JHtml::_('grid.sort', 'N&uacute;mero', 'numero', $direction, $ordering); ?>  
                </th>                                                
            </tr>
        </thead>
        <tbody>            
            <?php foreach ($this->items as $i => $item): ?>
                ...
                <tr class="row<?php echo $i % 2; ?>">
                    <td>
                        <?php echo $item->idDepartamento; ?>
                    </td>
                    <td>
                        <?php echo JHtml::_('grid.id', $i, $item->idDepartamento); ?>
                    </td>
                    <td class="center">
                        <?php echo $item->nombre_fracc; ?>                        
                    </td>
                    <td class="center">
                        <a href="<?php echo JRoute::_('index.php?option=com_sasfe&view=catdepartamento&layout=edit&id=' . $item->idDepartamento); ?>">
