...
class  SasfeViewSmsconfigcreditos extends JViewLegacy
{
	protected $items;
	...
	{                        
            ...
            $this->pathUrl = 'index.php?option=com_sasfe&task=smsconfigcreditos.';
        ...
        {                     
            ...
            JToolBarHelper::title(JText::_('Configuraci&oacute;n de Cr&eacute;ditos'), 'smsconfigcreditos');
            
            // JToolBarHelper::apply('smsconfigcreditos.apply');
            // JToolBarHelper::custom( 'smsconfigcreditos.sendMessage', '', '', 'Enviar mensaje', false, false );
            //JToolBarHelper::spacer();
            JToolBarHelper::cancel('smsconfigcreditos.cancel');            
            //submenu
            ...
            if($this->permiso==true){
                ...
                JSubMenuHelper::addEntry('Reportes', 'index.php?option=com_sasfe&view=smsconfigcreditos', false);
                ...
                JSubMenuHelper::addEntry('Configuraci&oacute;n Cr&eacute;ditos', 'index.php?option=com_sasfe&view=smsconfigcreditos', true);                
            }
        }
        ...
        protected function setDocument() 
        {
            ...
            $document = JFactory::getDocument();                                
            $document->setTitle(JText::_('Configuracion de Creditos'));                                
            ...
            $document->addScript(JURI::root().'administrator/components/com_sasfe/views/smsconfigcreditos/submitbutton.js'); 
        }
}
