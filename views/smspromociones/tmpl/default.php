...
<form action="<?php echo JRoute::_('index.php?option=com_sasfe&view=smspromociones'); ?>" method="post" name="adminForm" id="adminForm">
        ...
        <thead>
            <tr>
                <th width="5" class="nowrap center">                    
                    <?php echo JHtml::_('grid.sort', 'ID', 'idPromo', $direction, $ordering); ?>                    
                </th>
                ...
                <th class="nowrap center">                    
                    <?php echo JHtml::_('grid.sort', 'Promoci&oacute;n', 'texto', $direction, $ordering); ?>  
                </th>
                <th class="nowrap center">                    
        ...
        <tbody>
            <?php foreach ($this->items as $i => $item): ?>
                ...
                <tr class="row<?php echo $i % 2; ?>">
                    <td>
                        <?php echo $item->idPromo; ?>
                    </td>
                    <td>
                        <?php echo JHtml::_('grid.id', $i, $item->idPromo); ?>
                    </td>
                    <td class="center">
                         <?php echo $item->titulo; ?>
                    </td>                    
                    <td class="center">
                        <a href="<?php echo JRoute::_('index.php?option=com_sasfe&view=smspromocion&layout=edit&id=' . $item->idPromo); ?>">
                            <?php echo $item->texto; ?>
                       </a>
                    </td>
                    <td class="center">
