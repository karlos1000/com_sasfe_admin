...
<form action="<?php echo JRoute::_('index.php?option=com_sasfe&view=motivos'); ?>" method="post" name="adminForm" id="adminForm">
        ...
        <thead>
            <tr>
                <th width="5" class="nowrap center">
                    <?php echo JHtml::_('grid.sort', 'ID', 'idMotivo', $direction, $ordering); ?>
                </th>
        ...
        <tbody>
            <?php foreach ($this->items as $i => $item): ?>
                ...
                <tr class="row<?php echo $i % 2; ?>">
                    <td>
                        <?php echo $item->idMotivo; ?>
                    </td>
                    <td>
                        <?php echo JHtml::_('grid.id', $i, $item->idMotivo); ?>
                    </td>
                    <td class="center">
                         <?php echo $item->titulo; ?>
                    </td>
                    <td class="center">
                        <a href="<?php echo JRoute::_('index.php?option=com_sasfe&view=motivo&layout=edit&id=' . $item->idMotivo); ?>">
                            <?php echo $item->texto; ?>
                       </a>
                    </td>
                    <td class="center">
