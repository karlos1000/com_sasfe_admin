...
class  SasfeViewCattipoeventos extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
        ...
        {                     
            ...
            $document->addStyleDeclaration('.icon-48-tipoeventos {background-image: url(../media/com_sasfe/images/tipoeventos.png);}');                
            JToolBarHelper::title(JText::_('Cat&aacute;logo Tipo eventos'), 'tipoeventos');
            JToolBarHelper::deleteList('', 'cattipoeventos.delete');
            JToolBarHelper::editList('cattipoevento.edit');
            JToolBarHelper::addNew('cattipoevento.add');
            JToolBarHelper::spacer();
            JToolBarHelper::cancel('cattipoeventos.cancel');
            //submenu
        ...
        protected function setDocument() 
        {
            ...
            $document = JFactory::getDocument();                   
            $document->setTitle(JText::_('Catalogo Tipo eventos'));
            ...
            $document->addScript(JURI::root().'administrator/components/com_sasfe/views/cattipoeventos/submitbutton.js'); 
        }
}
