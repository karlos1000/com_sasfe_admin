...
<form action="<?php echo JRoute::_('index.php?option=com_sasfe&view=cattipoeventos'); ?>" method="post" name="adminForm" id="adminForm">
        ...
        <thead>
            <tr>
                <th width="5" class="nowrap center">                    
                    <?php echo JHtml::_('grid.sort', 'ID', 'idTipoEvento', $direction, $ordering); ?>                    
                </th>
                <th width="20" class="nowrap center">
                    <?php echo JText::_('Sel'); ?>                    
                </th>			
                <th class="nowrap center">                    
                    <?php echo JHtml::_('grid.sort', 'Nombre', 'tipoEvento', $direction, $ordering); ?>  
                </th>
                <th class="nowrap center">                    
        ...
        <tbody>            
            <?php foreach ($this->items as $i => $item): ?>
                ...
                <tr class="row<?php echo $i % 2; ?>">
                    <td>
                        <?php echo $item->idTipoEvento; ?>
                    </td>
                    <td>
                        <?php echo JHtml::_('grid.id', $i, $item->idTipoEvento); ?>
                    </td>
                    <td class="center">
                        <a href="<?php echo JRoute::_('index.php?option=com_sasfe&view=cattipoevento&layout=edit&id=' . $item->idTipoEvento); ?>">
                            <?php echo $item->tipoEvento; ?>
                       </a>                        
                    </td>                    
                    <td class="center">
                        <?php                         
