...
if($this->id==0){
    //Esta creando
    $nombreUsrJoomla = $this->user->name; //Nombre del usuario joomla que esta creando el contacto
    $idUsuarioJoomla = $this->user->id; //id del usuario joomla que esta creando el contacto

    //Solo aplica para agentes de venta
    ...
    //Solo aplica para gerentes de venta
    if(in_array("11", $this->groups)){
        $colAsesores = SasfehpHelper::obtColAsesoresAgtVentaXIdGteVentas($idUsuarioJoomla); //Obtener todos los asesores que le perteneces al gerente de ventas por su id
        // echo "<pre>";print_r($colAsesores);echo "</pre>";
    }
}else{
    //Esta editando
    ...
    <div style="">
        <fieldset class="adminform" style="display:inline-block;width:35%;float:right;">
            <div class="control-group">
                ...
                <div class="controls">
                    ...
                    <select id="fuente" name="fuente" class="required">
                        ...
                        foreach ($colCaptadosRand as $item) {
                            ...
                            // else
                            //     $sel = '';
                            echo '<option value="' . $item->idTipoCaptado . '">' . $item->tipoCaptado . '</option>';
                            // echo '<option value="'.rtrim($item->tipoCaptado).'">' . $item->tipoCaptado . '</option>';
                        }
                        ?>
                    </select>
                </div>
            ...
            <?php if(in_array("8", $this->groups) || in_array("10", $this->groups) || in_array("11", $this->groups) || in_array("17", $this->groups) || in_array("20", $this->groups) ){ ?>
                <?php if(in_array("11", $this->groups)){ ?>
                    <div class="control-group">
                        <div class="control-label">
                            <label for="nombreGteJoomla2">Gerente:</label>
                        </div>
                        <div class="controls">
                            <input type="text" id="nombreGteJoomla2" value="<?php echo $nombreUsrJoomla; ?>" class="" style="width:180px;" readonly/>
                            <input type="hidden" name="nombreGteJoomlaVentas" id="nombreGteJoomlaVentas" value="<?php echo $idUsuarioJoomla; ?>">
                        </div>
                    </div>
                    <div class="control-group">
                        <div class="control-label">
                        ...
                        <div class="controls" id="cont_usuarioAgenteVentas">
                            <select id="usuarioAgenteVentas" name="usuarioAgenteVentas" class="required">
                                <option value="">--Seleccione--</option>
            ...
            <?php if(in_array("18", $this->groups)){ ?>
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" id="nombreGteJoomla2" value="<?php echo $nombreGteJoomla; ?>" class="" style="width:180px;" readonly/>
                        <input type="hidden" name="nombreGteJoomlaVentas" id="nombreGteJoomlaVentas" value="<?php echo $idGteJoomla; ?>">
                    </div>
                </div>
                <div class="control-group">
                    <div class="control-label">
                    ...
                    <div class="controls">
                        <input type="text" id="usuarioAgenteVentas2" value="<?php echo $nombreUsrJoomla; ?>" class="" style="width:180px;" readonly/>
                        <input type="hidden" name="usuarioAgenteVentas" id="usuarioAgenteVentas" value="<?php echo $idUsuarioJoomla; ?>">
                    </div>
                </div>
            <?php } ?>
        ...
        <fieldset class="adminform">
                ...
                <div class="controls">
                    <select id="estatusContactoId" name="estatusContactoId" class="required">
                        ...
                        foreach ($colEstatusContacto as $item) {
                            if ($item->idEstatus!=4 && $item->idEstatus!=5 && $item->idEstatus!=6){
            ...
            <!-- <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" name="credito" id="credito" value="<?php echo $credito; ?>" class="mayuscula" style="width:180px;"/>
                </div>
            </div> -->
        </fieldset>
    </div>
