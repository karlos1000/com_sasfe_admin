JQ(document).ready(function(){
  var estatusContactoIdInit = JQ("#estatusContactoId").val(); //obtener valor del estatus
  ...
  JQ("#estatusContactoId").change(function (){
    ...
    if(idEstatus==5){
      ...
      if (r == true) {
        ...
        JQ("#estatusContactoId").val(estatusContactoIdInit);
        return false;
      }
    }
  });
  ...
  JQ(".selAgregarAccion").click(function(){
    ...
    JQ('#arrIdCont').val(JQ("#check_un").val()); //agregar id seleccionado (contacto)
    JQ('#idAgtVentasNA').val(JQ("#usuarioAgenteVentas").val()); //agregar id agente de ventas
  });
