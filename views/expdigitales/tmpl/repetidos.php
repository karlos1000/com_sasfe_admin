...
<form action="<?php echo JRoute::_('index.php?option=com_sasfe&view=prospectos&layout=repetidos'); ?>" method="post" name="adminForm" id="adminForm">
    ...
    <div class="filter-select fltrt">
        ...
        <?php if(in_array("19", $this->groups) || in_array("11", $this->groups) || in_array("10", $this->groups)){ ?>
                ...
                <tr class="row<?php echo $i % 2; ?>">
                    ...
                    <td class="center">
                        ...
                        <?php if(in_array("19", $this->groups) || in_array("11", $this->groups)){ ?>
                            <!-- Validar si prospecto duplicado pertenece a dos gerencias diferentes, Imp. 18/05/20 -->
                            <?php
                            $respDifGerencia = SasfehpHelper::revisaGerenciasPorRfc($item->RFC);
...
<div class="modal fade" id="popup_validar_prospecto_repetido" role="dialog" style="width:400px;position:relative !important;display:none;">
    <div class="modal-dialog">          
      <div class="modal-content">
          ...
          <?php if(in_array("19", $this->groups) || in_array("8", $this->groups) || in_array("10", $this->groups)){ ?>
          ...
          <div class="modal-body cont_form_popup">            
            <form id="form_rep_prospecto_repetido" class="form-horizontal" action="<?php echo JRoute::_('index.php?option=com_sasfe&view=prospectos&task=prospecto.validarprospectorepetido'); ?>" method="post">                
                ...
                <div class="divPupopSinTop pupopAlert">Nota: Antes de cambiar gerente verificar si ya tiene <br/>asignado un asesor si es as&iacute;, debe antes de cambiar <br/>el gerente asociado en el <a href="index.php?option=com_sasfe&view=catgenericos&id_cat=3">cat&aacute;logo de asesores</a>. </div>
                <br/>                
                <?php } ?>
